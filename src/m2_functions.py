...
def turtle4():
    ...
    jose = rg.SimpleTurtle("turtle")
    jose.pen = rg.Pen('green', 16)
...
def turtle5():
    ...
    frank = rg.SimpleTurtle("square")
    frank.pen = rg.Pen("pink",5)
    frank.paint_bucket = rg.PaintBucket('blue')

    frank.begin_fill()
    frank.draw_regular_polygon(5, 200)
    frank.end_fill()

    danny = rg.SimpleTurtle("arrow")
    danny.pen = rg.Pen('midnight blue', 20)

    danny.draw_square(20)
