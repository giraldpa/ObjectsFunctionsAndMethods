...
#            draws all of the objects attached to that window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            At the end of example3 because that is the last function that
# is called, so if you have it after example one or two, the other functions
#  will not run.
#
